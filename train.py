from src.utils import setup_trace_transforms, setup_output_dirs, setup_mfr_transforms
from src.AvaDataset import AvaPretrainDataset
...
if __name__ == "__main__":
    ...
    trace_transforms = setup_trace_transforms(
        fs=fs,
        decimate=True,
        add_noise=True,
        bandpass_first=False,
        average_interval=True,
        taper=False,
        minmax=True,
        use_gaf=False,
    ...
    mfr_transforms = setup_mfr_transforms(apply_colormap=False)
    ...
    for dataset_type in dataset_types:
        datasets[dataset_type] = AvaPretrainDataset(
            ...
            trace_transform=trace_transforms
        )
